...
using Athena.Models;
using Athena.Providers;
using Athena.Results;
using System.Linq;
...
namespace Athena.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                var errors = this.ModelState.Keys.SelectMany(key => this.ModelState[key].Errors); //debug line
                return BadRequest(ModelState);
            }
            ...
            var user = new ApplicationUser()
            {
                ...
                Email = model.Email,
                MyWorks = model.MyWorks,
                Read = model.Read,
                Reading = model.Reading,
                ToRead = model.ToRead,
                Favorites = model.Favorites,
                FavoriteGenres = model.FavoriteGenres,
                MyReviews = model.MyReviews,
                MyRatings = model.MyRatings,
                MyComments = model.MyComments,
                ProfileComments = model.ProfileComments,
            };
